    ...
    <section className=" flex flex-col gap-4 items-center py-16 pb-[200px] bg-gradient-to-r from-purple-800 to-indigo-900">
      ...
      <div className="w-full h-[50vh]  mb-11 flex items-center justify-center">
        ...
        <div className="relative w-[100vh]   glide-08">
          {/*    <!-- Slides --> */}
          <div
            className="overflow-hidden text-center bg-slate-300 rounded shadow-2xl text-slate-500 shadow-slate-200 "
            data-glide-el="track"
          >
                  ...
                  <div className="overflow-hidden ">
                    <div className="relative p-6">
                      <figure className="relative z-10">
                        <blockquote className="p-6 text-lg leading-loose lg:text-xl hover:text-orange-500 hover:text-2xl">
                          <p>
                            Wind-ui is probably one of the best libraries I've
                            come across. Good looking, easy to use and above all
                            super accessible. If you haven't tried it yet just
                            do so!
                          </p>
                        </blockquote>
                        <figcaption className="flex flex-col items-center gap-2 p-6 text-sm text-emerald-500">
                          ...
                          <div className="flex items-center gap-4 pt-4 text-sm text-left text-emerald-500">
                            <img
                              ...
                              width="100"
                              height="90"
                              className="max-w-full rounded-3xl shrink-0"
                            />
                            <div className="flex flex-col gap-1">
                              <span className="font-bold uppercase text-2xl  hover:text-green-700 hover:text-3xl">
                                Nikhil
                              </span>
                              <cite className="not-italic  hover:text-green-700 text-sm hover:text-2xl">
                                <a href="#">Co-Founder,Market Lead</a>
                              </cite>
                            </div>
                          </div>
                        </figcaption>
                      ...
                      <figure className="relative z-10">
                        <blockquote className="p-6 text-lg leading-loose lg:text-xl  hover:text-orange-500 hover:text-2xl">
                          <p>
                            ...
                            ensure full accessibility with the WAI-ARIA
                            standards. That's just awesome for a free ui
                            library.
                          </p>
                        </blockquote>
                        <figcaption className="flex flex-col items-center gap-2 p-6 text-sm text-emerald-500">
                    ...
                    <div className="relative p-6">
                      <figure className="relative z-10">
                        ...
                        <figcaption className="flex flex-col items-center gap-2 p-6 text-sm text-emerald-500">
                          ...
                          <div className="flex items-center gap-4 pt-4 text-sm text-left ">
                            <img
                              src="https://i.pravatar.cc/40?img=11"
                              alt="user name"
                              title="user name"
                            ...
                            <div className="flex flex-col gap-1">
                              ...
                              <cite className="not-italic  hover:text-green-700 text-sm hover:text-2xl">
                                <a href="#">Co-Founder, Software Developer</a>
                              </cite>
                            </div>
                          </div>
                        </figcaption>
                        ...
                        <figcaption className="flex flex-col items-center gap-2 p-6 text-sm text-emerald-500">
                          ...
                          <div className="flex items-center gap-4 pt-4 text-sm text-left text-emerald-500">
                            ...
                            <div className="flex flex-col gap-1">
                              ...
                              <cite className="not-italic  hover:text-green-700 text-sm hover:text-2xl">
                                <a href="#">Co-Founder,Designing Lead</a>
                              </cite>
                            </div>
                          </div>
                        </figcaption>
