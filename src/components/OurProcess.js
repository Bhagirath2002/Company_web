...
const RightContent = () => (
  <div className="h-screen bg-gray-300 flex justify-center items-center">
    <div className="max-w-[90%] lg:max-w-[80%] p-4">
      <Swiper
        breakpoints={{
          0: {
            slidesPerView: 2,
        ...
        {ServiceData.map((item) => (
          <SwiperSlide key={item.title}>
            <div className="flex flex-col gap-6 mb-20 group relative shadow-lg text-white rounded-xl px-6 py-8 h-[250px] lg:h-[400px] overflow-hidden cursor-pointer">
              <div
                className="absolute inset-0 bg-cover bg-center bg-gradient-to-r from-purple-800 to-green-800
                "
              ...
              <div className="relative flex flex-col gap-3">
                ...
                <p className="lg:text-[12px] text-justify ">{item.content}</p>
              </div>
